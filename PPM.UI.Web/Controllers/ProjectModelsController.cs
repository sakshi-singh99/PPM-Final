...
namespace PPM.UI.Web.Controllers
{
    ...
    {
        private AppDbContextEntities db = new AppDbContextEntities();
        ...
        public ActionResult Create([Bind(Include = "ProjectId,ProjectName,ProjectStartDate,ProjectEndDate")] ProjectModel projectModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProjectId,ProjectName,ProjectStartDate,ProjectEndDate")] ProjectModel projectModel)
        {
            if (ModelState.IsValid)
            {
